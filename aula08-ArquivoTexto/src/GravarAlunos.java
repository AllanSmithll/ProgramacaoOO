...
public class GravarAlunos{
	public static void main(String[]args) {
		...
		try{
			arquivo2 = new FileWriter( new File("aprovados.csv"), true ); 
			arquivo3 = new FileWriter( new File("reprovados.csv"), true );  
		}
		catch(Exception e){
		...
		try {
			...
			System.out.println("problema na grava��o do arquivo"+e.getMessage());
		}
